...
var age = document.getElementById('age'); // 計算結果を出力する要素を取得
...
window.addEventListener('load', function () {
  ...
  totalRepayment.innerHTML = parseFloat(annualRepaymentAmountCalc(borrowingAmountValue, annualInterestValue, borrowingPeriodValue) * borrowingPeriodValue).toFixed(1); // 年間家賃収入の計算・表示
...
setInterval(inputImage1, 1000); // window.addEventListener('DOMContentLoaded', inputImage);
...
setInterval(inputImage2, 1000); // window.addEventListener('DOMContentLoaded', inputImage);
